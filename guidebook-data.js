    ...
    "services":  [
                     {
                         ...
                         "sections":  [
                                          ...
                                          },
                                          {
                                              ...
                                              "location":  "작성창의 + 버튼을 누른 뒤 이미지 만들기를 선택하거나, 채팅창에 만들고 싶은 이미지를 문장으로 요청합니다.",
                                              "when":  "보고서, 교육자료, 홍보물, 발표자료에 넣을 새 이미지가 필요할 때 사용합니다. 기존 이미지를 세밀하게 편집하는 기능과는 구분해서, 새 이미지를 생성하는 용도로 설명합니다.",
                                              "how":  "원하는 주제, 장면, 스타일, 색감, 비율, 포함할 문구, 제외할 요소를 구체적으로 적으면 더 원하는 결과에 가까워집니다. 사람 얼굴, 로고, 실제 기관명처럼 정확도가 중요한 요소는 생성 후 반드시 확인합니다.",
                                              "steps":  [
                                                            {
                                                                "title":  "이미지 만들기를 선택합니다",
                                                                "body":  "작성창의 + 버튼을 누르고 이미지 만들기를 선택합니다. 메뉴를 쓰지 않아도 “AI 교육 안내 포스터 이미지를 만들어 주세요”처럼 채팅창에 바로 요청할 수 있습니다.",
                                                                "image":  "./guidebook-assets/chatgpt_overview.png",
                                                                "badge":  "기능 선택"
                                                            },
                                                            {
                                                                "title":  "원하는 이미지를 구체적으로 설명합니다",
                                                                "body":  "무엇을 그릴지, 어떤 분위기인지, 어디에 쓸 이미지인지, 가로형인지 세로형인지, 넣으면 안 되는 요소가 있는지 적습니다. 예를 들어 “사내 교육자료 표지용, 밝고 신뢰감 있는 분위기, 사람은 작게, 텍스트 없이”처럼 작성합니다.",
                                                                "image":  "./guidebook-assets/chatgpt_overview.png",
                                                                "badge":  "요청 작성"
                                                            },
                                                            {
                                                                "title":  "결과를 확인하고 다시 요청합니다",
                                                                "body":  "생성된 이미지를 확인한 뒤 색감, 구도, 문구, 세부 요소가 맞지 않으면 이어서 수정 방향을 요청합니다. 최종 사용 전에는 저작권, 로고, 인물, 기관명처럼 민감한 부분을 다시 확인합니다.",
                                                                "image":  "./guidebook-assets/chatgpt_overview.png",
                                                                "badge":  "결과 확인"
                                                            }
                                                        ]
