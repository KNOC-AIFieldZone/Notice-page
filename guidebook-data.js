                         ...
                         "sections":  [
                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              {
                                                                  "title":  "작업에서 목표·자료·완료 기준을 입력합니다",
                                                                  "body":  "왼쪽 ‘작업’을 선택한 뒤 가운데 ‘작업을 설명하세요’ 입력창에 목표, 사용할 자료, 결과 형식과 완료 기준을 적습니다. + 버튼에서는 기기 파일, Drive 파일 또는 Notebook을 추가할 수 있고, 기존 기능을 지정하려면 입력 중 /를 눌러 기능을 선택합니다. 공개 자료 조사 예시는 ‘공식 공개 자료를 사용해 최근 7일간 국내외 생성형 AI 정책 발표를 조사하고, 발표일·기관·핵심 내용·원문 링크를 표로 정리해 주세요. 출처가 확인되지 않는 내용은 제외하고, 외부 서비스의 자료를 변경하거나 메시지를 보내야 하면 실행 전에 승인을 요청하세요.’입니다. 전송 후 Spark가 만든 계획과 사용할 앱·자료를 확인하고 작업을 시작합니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "작업 요청"
                                                              },
                                                              {
                                                                  "title":  "작업의 단계·파일·승인 요청과 결과를 확인합니다",
                                                                  "body":  "작업 대화 상단의 진행 상태를 누르거나 작업 패널을 열면 ‘진행 상황’에서 완료·진행 중·예정 단계를 볼 수 있고, ‘파일’에서 Spark가 읽거나 수정한 파일을 열어 확인할 수 있습니다. Spark가 브라우저 조작, 문서 변경, 메시지 전송처럼 확인이 필요한 행동을 요청하면 계획과 대상 정보를 읽고 승인하거나 직접 제어합니다. 추가 지시는 같은 작업 대화에 입력합니다. 모든 작업은 왼쪽 ‘작업’ 목록에서 상태별로 필터링하고, 중요한 작업은 고정하거나 이름을 바꾸며 불필요한 작업은 삭제할 수 있습니다. 결과의 출처·수치·파일 변경 내역은 원문과 대조하고, 의도와 다르면 중지한 뒤 범위를 수정해 주세요.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "작업 확인"
                                                              },
                                                              {
                                                                  "title":  "일정에서 실행 시점과 조건을 설정합니다",
                                                                  "body":  "왼쪽 ‘일정’을 선택하면 Spark 작업을 자동으로 시작할 조건을 만들 수 있습니다. 작업 대화에서 ‘매주 월요일 오전 8시에 공식 기관의 지난주 AI 정책 발표를 찾아 기관·발표일·핵심 내용·원문 링크를 표로 정리해 주세요.’처럼 요청하거나, 일정 화면의 ‘직접 만들기’에서 이름, 실행 시점과 작업 지침을 입력합니다. 시간 기반 일정은 한 번·매시간·매일·매주·매월·매년 실행할 수 있고, 대화로 만들 때는 조건에 맞는 Gmail 수신 또는 뉴스·금융·스포츠·지역 행사 등의 주제 변화를 감시하는 일정도 요청할 수 있습니다. 기존 기능을 적용하려면 지침에서 /를 눌러 선택합니다. 일반 Gemini 채팅의 ‘예약된 작업’과 Spark의 일정은 서로 다른 기능입니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "일정 만들기"
                                                              },
                                                              {
                                                                  "title":  "일정을 시험하고 실행 상태를 관리합니다",
                                                                  "body":  "일정을 만든 뒤 ‘계속 진행 중’ 목록에서 더보기 메뉴의 ‘지금 실행’을 눌러 지침과 결과 형식을 먼저 시험합니다. 일정 상세 화면이나 관련 작업 대화에서 실행 시점·지침을 수정하고, 필요에 따라 일시중지·재개·삭제합니다. 일정 화면은 계속 진행 중, 일시중지됨, 완료됨으로 나뉘며, 일정이 실행될 때마다 관련 작업에서 결과와 사용한 자료를 확인할 수 있습니다. 예약 시각은 근사값이며 트래픽이나 실행 중인 작업 수에 따라 지연될 수 있고, 빠르게 변하는 값이나 즉시 대응이 필요한 감시 용도로는 적합하지 않습니다. 오프라인 실행 중에는 의도하지 않은 행동을 즉시 멈추기 어려우므로 민감한 정보나 외부 전송이 포함된 자동화는 만들지 않는 편이 안전합니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "일정 관리"
                                                              },
                                                              {
                                                                  "title":  "기능에서 반복 절차와 출력 규칙을 저장합니다",
                                                                  "body":  "왼쪽 ‘기능’을 선택하면 여러 작업에서 반복 사용할 지침을 만들 수 있습니다. ‘Gemini로 만들기’를 눌러 대화로 생성하거나, 추천 템플릿을 수정하거나, ‘직접 만들기’에서 이름·설명·지침을 입력합니다. 예를 들어 이름은 ‘공식 자료 브리핑’, 설명은 ‘공식 발표를 검증해 표와 요약으로 정리’, 지침은 ‘공식 기관 원문을 우선하고 발표일·기관·제목·핵심 내용·원문 링크를 표로 작성하세요. 출처가 없거나 날짜가 불명확한 항목은 제외하고 마지막에 확인이 필요한 사항을 적으세요.’라고 작성합니다. 한 기능에는 한 가지 반복 업무만 담고, 처리 순서·자료 우선순위·출력 형식·금지 사항을 구체적으로 적은 뒤 생성합니다. 필요하면 기능 파일을 업로드할 수 있지만 외부 인터넷 접근이 필요한 업로드 스크립트는 현재 지원되지 않습니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "기능 만들기"
                                                              },
                                                              {
                                                                  "title":  "작업과 일정에서 기능을 호출하고 관리합니다",
                                                                  "body":  "새 작업이나 일정의 지침 입력 중 /를 누르고 저장한 기능을 선택하면 해당 지침과 자료를 이번 실행에 적용할 수 있습니다. 관련성이 높은 활성 기능은 Spark가 문맥에 따라 자동으로 사용할 수도 있고, 복잡한 작업에는 여러 기능을 함께 지정할 수 있습니다. 작업 패널의 ‘기능 및 앱’에서 실제로 사용된 항목을 확인하고 결과가 저장한 절차를 따랐는지 검토합니다. 자동 적용을 원하지 않는 기능은 기능 상세의 더보기에서 사용 중지하고 저장하며, 삭제는 기능 목록에서만 할 수 있고 되돌릴 수 없으므로 먼저 내려받거나 지침을 보관해 주세요. 기능이나 연결 앱이 접근하는 자료와 수행 가능한 행동은 작업을 실행하기 전에 확인합니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "기능 사용"
                                                              }
