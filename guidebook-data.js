                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "생성이 완료되면 Gemini가 미니 앱의 처리 단계를 보여 주고 오른쪽에 실제 화면 미리보기를 표시합니다. 단계가 요청한 순서와 입력·출력 형식으로 구성되었는지 확인한 뒤 ‘Start app’을 눌러 샘플 자료로 실행합니다. 수정이 필요하면 단계 아래 입력창에 ‘법령 원문 링크가 없는 항목은 결과에서 제외하고, 시행일이 지난 조항은 별도로 표시해 주세요.’처럼 변경 사항을 적습니다. 더 복잡한 수정은 상단의 고급 편집기에서 할 수 있으며, 공유 전에는 입력 자료의 보안 등급, 결과의 법적 최신성·정확성, 공개 범위를 확인합니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "이미지 추가 예정"
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "대화형 전문가가 필요하면 Gem 관리자의 기존 Gem 영역에서 ‘New Gem’을 선택합니다. 이름에는 ‘공공기관 법령 검토 도우미’를 입력하고, 지침에는 역할·처리 절차·출력 형식·제약 조건을 구체적으로 적습니다. 예시는 다음과 같습니다. ‘당신은 한국 공공기관의 법령·규정 검토를 지원하는 업무 보조자입니다. 사용자가 법령명, 조문, 질문 또는 내부 규정 파일을 제공하면 ① 적용되는 법령과 조항 ② 시행일과 소관 기관 ③ 주요 의무·예외·벌칙 ④ 내부 규정과의 차이 ⑤ 실무 체크리스트 순서로 답변하세요. 표와 쉬운 한국어를 사용하고, 근거가 있는 항목에는 원문 링크나 첨부 파일의 위치를 표시하세요. 폐지·개정 여부나 출처가 불확실하면 추정하지 말고 확인 필요로 구분하며, 최종 법률 판단은 담당 부서 검토가 필요하다고 안내하세요.’ 짧게 쓴 지침은 ‘Gemini로 지침 다시 쓰기’를 눌러 확장한 뒤 직접 검토할 수 있습니다. ‘Knowledge’의 ‘Add files’에서는 기기 또는 Google Drive의 법령집·내부 규정·업무 매뉴얼을 추가합니다. 오른쪽 미리보기에서 질문을 시험한 뒤 반드시 ‘Save’를 눌러 저장하며, 미리보기만 실행하면 저장되지 않습니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "이미지 추가 예정"
                                                              },
                                                              {
                                                                  "title":  "저장한 맞춤 Gem을 선택해 반복 질의합니다",
                                                                  "body":  "저장한 Gem은 ‘My Gems’와 Gemini의 Gem 목록에 표시됩니다. ‘공공기관 법령 검토 도우미’를 선택한 뒤 ‘첨부한 내부 지침에서 생성형 AI 서비스를 사용할 때 사전 검토해야 할 항목을 근거 조항과 함께 표로 정리하고, 담당 부서 확인 질문을 만들어 주세요.’처럼 실제 업무 질문을 입력합니다. Gem은 저장된 지침과 지식 파일을 기준으로 같은 순서와 형식의 답변을 반복해서 제공합니다. 필요한 경우 Gem 편집 화면에서 지침과 파일을 갱신하고, 공유할 때는 열람자도 Gem 지침과 업로드 파일을 볼 수 있으며 편집자는 이를 변경하거나 삭제할 수 있으므로 사용자별 권한과 조직의 Drive 공유 정책을 확인합니다. 맞춤 답변에 표시된 조문·시행일·인용도 최신 법령 원문과 담당 부서 검토를 거쳐 사용합니다.",
                                                                  "image":  "",
                                                                  "hideImage":  true,
                                                                  "badge":  "이미지 추가 예정"
                                                              }
