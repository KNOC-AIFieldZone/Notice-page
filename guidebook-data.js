window.SERVICE_GUIDES = {
    ...
    "services":  [
                         ...
                         "tone": "#10b981",
                         "role": "글쓰기, 요약, 조사, 파일 분석, 이미지 작업, 자동화까지 한 화면에서 처리하는 범용 AI 업무 도구",
                         "basis": "2026-08-10",
                         "overview": "ChatGPT는 자연어로 질문하고 지시하면 답변, 문서 초안, 조사, 파일 분석, 이미지 생성, 반복 업무 예약까지 이어서 처리할 수 있는 AI 서비스입니다. 간단한 질문은 Chat에서 빠르게 처리하고, 파일·플러그인·여러 단계가 필요한 업무는 Work 모드에서 진행하면 좋습니다.",
                         ...
                         "sections": [
                             {
                                 ...
                                 "when": "질문, 글쓰기, 요약, 번역, 아이디어 정리처럼 대부분의 기본 업무를 빠르게 시작할 때 사용합니다.",
                                 "how": "무엇을 해야 하는지, 참고해야 할 맥락, 원하는 말투와 출력 형식을 한 문장 안에 같이 적으면 결과가 안정적입니다.",
                                 "steps": [
                                     "ChatGPT 첫 화면에서 입력창을 클릭합니다. 짧은 질문도 가능하지만 업무용이면 “무엇을 만들지”를 먼저 적습니다.",
                                     "예를 들어 “신입 직원에게 보낼 교육 안내 메일을 정중한 말투로 작성해 주세요. 제목 3개도 함께 주세요.”처럼 목적과 형식을 같이 입력합니다.",
                                     "답변을 읽고 부족한 부분은 “더 짧게”, “표로 정리해 주세요”, “공공기관 보고서 말투로 바꿔 주세요”처럼 이어서 요청합니다."
                                 ]
                             },
                             {
                                 "title": "파일/사진 첨부",
                                 "image": "./guidebook-assets/chatgpt_overview.png",
                                 "location": "작성창 왼쪽의 파일 추가 버튼에서 사진 및 파일 추가를 선택합니다.",
                                 "when": "PDF, 문서, 엑셀, 이미지, 스크린샷을 바탕으로 요약, 검토, 비교, 추출 작업을 할 때 사용합니다.",
                                 "how": "파일을 올린 뒤 “이 파일에서 무엇을 확인할지”를 구체적으로 말해야 합니다.",
                                 "steps": [
                                     "작성창의 “파일 등 추가” 버튼을 누르고 “사진 및 파일 추가” 또는 “컴퓨터에서 업로드하세요”를 선택합니다.",
                                     "파일을 첨부한 뒤 “핵심 내용을 5줄로 요약해 주세요”, “위험 문구를 찾아 주세요”, “표의 이상치를 찾아 주세요”처럼 작업을 입력합니다.",
                                     "답변이 나온 뒤에는 파일명, 페이지, 표의 행·열 같은 근거가 맞는지 원본과 대조합니다."
                                 ]
                             },
                             {
                                 "title": "라이브러리",
                                 "image": "./guidebook-assets/chatgpt_overview.png",
                                 "location": "왼쪽 사이드바의 라이브러리 메뉴 또는 작성창 파일 메뉴의 라이브러리에서 가져오기를 사용합니다.",
                                 "when": "이전에 올린 이미지와 파일을 다시 찾거나, 새 채팅에서 기존 자료를 재사용할 때 사용합니다.",
                                 "how": "자료가 많을수록 파일명 검색과 이미지/파일 필터를 먼저 쓰면 찾기 쉽습니다.",
                                 "steps": [
                                     "왼쪽 사이드바에서 “라이브러리”를 누릅니다. 화면에는 이미지와 파일 목록, 검색창, 업로드 버튼이 표시됩니다.",
                                     "검색창에 파일명이나 키워드를 입력하거나 “이미지”, “파일” 구분을 보고 필요한 자료를 찾습니다.",
                                     "새 대화에서 같은 자료를 쓰려면 작성창의 “파일 등 추가”를 누른 뒤 “라이브러리에서 가져오기”를 선택합니다."
                                 ]
                             },
                             {
                                 "title": "웹 검색",
                                 ...
                                 "when": "최신 정책, 뉴스, 제품 정보, 시장 동향처럼 모델 지식만으로 부족한 내용을 확인할 때 사용합니다.",
                                 "how": "검색 결과는 참고 자료이므로 날짜, 기관, 원문 맥락을 반드시 확인해야 합니다.",
                                 "steps": [
                             ...
                             },
                             {
                                 ...
                                 "when": "여러 자료를 읽고 비교·종합해야 하는 긴 조사 보고서나 의사결정 자료를 만들 때 사용합니다.",
                                 "how": "조사 질문, 제외할 범위, 비교 기준, 최종 형식을 미리 정해 주면 품질이 좋아집니다.",
                                 "steps": [
                             ...
                             },
                             {
                                 ...
                                 "how": "프로젝트 지침에 말투, 보고서 형식, 참고 자료 기준을 넣어 두면 반복 업무 품질이 일정해집니다.",
                                 "steps": [
                             ...
                             },
                             {
                                 ...
                                 "how": "외부 GPT를 사용할 때는 입력 자료 범위와 보안 정책을 먼저 확인해야 합니다.",
                                 "steps": [
                             ...
                             },
                             {
                                 ...
                                 "how": "좋은 스킬은 목적, 입력 자료, 처리 순서, 결과물 형식을 짧고 명확하게 담고 있어야 합니다.",
                                 "steps": [
                             ...
                             },
                             {
                                 ...
                                 "how": "어려운 분석은 높은 추론 수준이 유리하지만, 간단한 작업은 낮은 수준이 더 빠릅니다.",
                                 "steps": [
