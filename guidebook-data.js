                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "예를 들어 ‘임직원 대상 생성형 AI 안전 활용 교육자료를 7장 슬라이드로 만들어 주세요. 1장은 표지, 2장은 활용 가능한 업무, 3장은 RTF+C 방식의 좋은 프롬프트 작성법, 4장은 사실 확인 방법, 5장은 보안·개인정보·저작권 주의사항, 6장은 업무 적용 전 체크리스트, 7장은 핵심 요약으로 구성하고 전문적이고 간결한 디자인을 사용해 주세요.’라고 입력하고 전송합니다. 왼쪽 채팅에는 생성된 슬라이드의 구성 요약이 표시되고, 오른쪽 Canvas에서는 화살표로 장을 넘기며 내용과 디자인을 확인합니다. 수정할 부분이 있으면 채팅에서 ‘2장의 활용 사례를 석유·에너지 업무 중심으로 바꿔 주세요.’처럼 대상과 변경 내용을 지정합니다. 상단의 공유 아이콘으로 공동 검토 링크를 만들거나 ‘내보내기’에서 제공되는 형식으로 결과물을 옮길 수 있습니다. 내보내거나 공유하기 전에는 수치·사례·이미지의 정확성, 민감정보와 링크 공개 범위를 확인합니다.",
                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "예를 들어 ‘2024년 1월부터 2026년 8월까지 발표된 국내외 공공기관과 에너지 기업의 생성형 AI 업무 활용 사례를 조사해 주세요. 활용 업무, 도입 방식, 공개된 성과, 보안·개인정보 통제 방안을 표로 비교하고, 한국 공공기관이 시범 적용할 수 있는 과제 5개와 위험 대응 방안을 제안해 주세요. 정부·기업의 공식 자료와 신뢰할 수 있는 연구기관 자료를 우선하고, 확인되지 않은 수치는 제외하며, 모든 핵심 주장에 원문 링크와 발표일을 표시해 주세요.’라고 입력합니다. Gemini가 제안한 조사 계획에서 범위·기간·비교 항목·우선 출처를 검토하고 필요하면 ‘계획 수정’을 선택한 뒤 ‘조사 시작’을 누릅니다. 완료된 보고서는 오른쪽 패널에서 목차와 표를 이용해 검토하고, 각 인용의 원문 링크를 열어 수치·발표일·문맥을 확인합니다. 상단의 ‘공유 및 내보내기’로 공유하거나 Docs로 내보낼 수 있고, ‘만들기’를 누르면 계정에 표시되는 웹페이지·인포그래픽·퀴즈 등의 형식이나 직접 입력한 시각화 요청으로 보고서를 다시 구성할 수 있습니다. 공식 안내상 조사는 보통 5~10분이 걸리며 복잡한 주제는 더 오래 걸릴 수 있습니다.",
                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "새 작업 창에서 관리하기 쉬운 ‘이름’을 적고, ‘요청 사항’에는 Gemini가 매번 수행할 업무와 결과 형식을 구체적으로 작성합니다. 예를 들어 이름은 ‘주간 AI 정책 브리핑’, 요청 사항은 ‘매주 발표된 국내 생성형 AI 정책과 공공기관 적용 사례를 공식 출처 중심으로 5건 수집해 발표일·기관·핵심 내용·원문 링크를 표로 요약해 주세요.’라고 작성할 수 있습니다. ‘실행 빈도’에서 매일·매주·매월 등 반복 주기를 선택하고 ‘완료 기한’에서 결과를 받을 시간을 정한 뒤 ‘만들기’를 누릅니다. 등록 시 예약 작업과 연결된 채팅이 생성되고, 이후 정해진 시간에 새 결과가 준비되면 채팅 목록에서 읽지 않은 항목과 알림으로 확인할 수 있습니다. 예약 결과는 미리 준비될 수 있으므로 급변하는 뉴스·가격·규정은 최신 원문을 다시 확인합니다.",
                                          ...
                                          },
                                          {
                                              ...
                                              "steps":  [
                                                              ...
                                                              },
                                                              {
                                                                  ...
                                                                  "body":  "Gem 관리자 상단의 ‘Gems made by Labs’에서는 Google Labs가 제공하는 미니 앱을 열어 사용하거나 원하는 흐름으로 리믹스할 수 있습니다. ‘My Gems from Labs’의 ‘New Gem’을 누르면 새 AI 미니 앱을 만들 수 있습니다. 아래 ‘Gem 관리자’의 Google 사전 제작 항목은 브레인스토밍·커리어 상담·코딩처럼 정해진 역할로 대화하는 기존 Gem이므로, 화면과 여러 처리 단계를 갖춘 업무 워크플로가 목적이라면 상단의 Labs 영역에서 시작합니다. Labs 미니 앱 생성·편집은 현재 만 18세 이상의 개인 Google 계정, 컴퓨터용 Gemini 웹 앱과 영어 환경에서 제공되며 업무·학교 계정에서는 지원되지 않습니다.",
                                                                  "image":  "./guidebook-assets/gemini_gems_02_manager.png",
                                                                  "badge":  "Gem 선택"
                                                              },
                                                              {
                                                                  "title":  "미니 앱의 입력·처리 단계·결과 형식을 설명합니다",
                                                                  "body":  "‘New Gem’을 누르면 아래 입력창에 만들 AI 미니 앱이나 워크플로를 자연어로 설명하는 화면이 열립니다. 단순히 ‘공공기관 법령 자료’처럼 주제만 적기보다 사용자가 무엇을 입력하고, 앱이 어떤 순서로 처리하며, 어떤 결과를 보여 줄지 작성합니다. 예시는 다음과 같습니다. ‘Build an AI mini app for Korean public-sector legal research. Ask the user for a policy topic, relevant law URLs, or source documents. Extract the law name, article number, effective date, responsible agency, key obligations, and exceptions. Compare related provisions in a table, cite the supplied sources, flag missing or conflicting information, and generate a plain-Korean summary and a compliance checklist. Create separate screens for input, source review, comparison, and final report.’ 입력 후 오른쪽 전송 아이콘을 누릅니다. 처음 사용할 때는 Gemini와 같은 개인 Google 계정으로 Opal에 로그인하라는 안내가 표시될 수 있습니다.",
                                                                  "image":  "./guidebook-assets/gemini_gems_03_labs_prompt.png",
                                                                  "badge":  "앱 설명 입력"
                                                              },
                                                              {
                                                                  "title":  "생성된 워크플로와 미리보기를 검토합니다",
                                                                  "body":  "생성이 끝나면 왼쪽에는 처음 입력한 요청과 Law Query, Fetch Legal Information, Generate HTML Display 같은 처리 단계가, 오른쪽에는 실제 미니 앱 미리보기가 표시됩니다. 각 단계의 화살표를 눌러 입력·처리·출력이 의도대로 연결됐는지 확인하고, 오른쪽 화면을 직접 조작해 검색·목차 이동·결과 표시가 작동하는지 시험합니다. 흐름을 바꾸려면 아래 ‘Edit these steps’에 ‘공식 법령 원문이 확인된 항목만 표시하고 조문·시행일·원문 링크를 함께 보여 주세요.’처럼 수정 요청을 입력합니다. 세부 모델·도구·단계 연결을 직접 다루려면 ‘Open Advanced Editor’를, 다른 사람에게 사용할 수 있게 전달하려면 ‘Share App’을 누릅니다. ‘Download file’은 이 미니 앱이 만든 현재 결과 파일을 내려받을 때 사용합니다. Labs는 실험 기능이므로 생성된 법령명·조문·시행일은 국가법령정보센터 등 공식 원문과 대조한 뒤 사용해 주세요.",
                                                                  "image":  "./guidebook-assets/gemini_gems_04_labs_result.png",
                                                                  "badge":  "Labs 결과 사용"
                                                              },
                                                              {
                                                                  "title":  "기존 맞춤 Gem의 이름·지침·지식 자료를 설정합니다",
                                                                  "body":  "대화형 전문가가 필요하면 Gem 관리자의 기존 Gem 영역에서 ‘새 Gem’을 선택합니다. 먼저 이름에 ‘공공기관 법령 검토 도우미’를 입력해야 오른쪽 미리보기가 활성화됩니다. 설명에는 ‘공공기관 업무 관련 법령·규정을 근거 중심으로 비교하고 실무 체크리스트로 정리합니다.’처럼 용도를 한 문장으로 적습니다. 요청 사항에는 다음처럼 역할·처리 순서·출력 형식·제약을 작성합니다. ‘당신은 한국 공공기관의 법령·규정 검토 보조자입니다. 질문이나 첨부 문서를 받으면 ① 적용 법령·조항 ② 시행일·소관 기관 ③ 주요 의무·예외·벌칙 ④ 검토가 필요한 차이 ⑤ 실무 체크리스트 순서로 답하세요. 표와 쉬운 한국어를 사용하고 근거 링크나 파일 위치를 표시하세요. 개정 여부나 출처가 불확실하면 추정하지 말고 확인 필요로 구분하세요.’ 반짝임 아이콘으로 지침을 다시 쓸 수 있지만 생성 문구는 직접 검토합니다. ‘기본 도구’는 메뉴를 열어 이 Gem에 필요한 도구가 계정에 표시될 때만 선택하고, 지식 파일 중심 검토라면 ‘기본 도구 없음’으로 시작해도 됩니다. ‘지식’의 +에서 기기나 Drive의 기준 자료를 추가합니다. ‘지식 출처 사용 중지’를 선택하면 지식 파일과 채팅에 추가한 파일의 인용 표시가 꺼지므로, 근거 확인이 필요한 가이드에서는 선택하지 않는 편이 좋습니다. 오른쪽 미리보기로 시험한 뒤 ‘저장’을 누릅니다. 미리보기만으로는 저장되지 않습니다.",
                                                                  "image":  "./guidebook-assets/gemini_gems_05_classic_create.png",
                                                                  "badge":  "맞춤 Gem 설정"
                                                              },
                                                              {
                                                                  "title":  "저장한 맞춤 Gem에 자료를 추가하고 질문합니다",
                                                                  "body":  "저장한 ‘공공기관 법령 검토 도우미’를 열면 저장한 이름·설명·요청 사항이 적용된 전용 입력 화면이 표시됩니다. 가운데 입력창에 ‘첨부한 지침에서 생성형 AI 서비스를 사용할 때 사전 검토해야 할 항목을 근거 조항과 함께 표로 정리하고, 담당 부서에 확인할 질문을 만들어 주세요.’처럼 대상 자료, 원하는 작업과 결과 형식을 적습니다. ‘소스’를 누르면 현재 계정에 표시되는 검색·연결 소스 중 이번 조사에 사용할 범위를 고를 수 있고, ‘파일’에서는 이번 질문에만 참고할 문서를 추가합니다. 오른쪽 모델 메뉴에서는 속도와 난이도에 맞는 모델을 선택한 뒤 전송합니다. Gem은 저장된 요청 사항과 지식 자료에 이번 질문의 소스·파일을 함께 적용하므로, 자주 쓰는 기준서는 Gem의 지식에 두고 건별 검토 문서는 질문할 때 첨부하면 관리하기 쉽습니다. 답변의 조문·시행일·인용은 최신 공식 원문과 담당 부서 검토를 거쳐 사용하며, 민감한 내부 자료는 조직의 업로드·공유 정책을 먼저 확인해 주세요.",
                                              ...
                                              "steps":  [
                                                              {
                                                                  ...
                                                                  "body":  "Gemini 화면 왼쪽 위에서 ‘Spark’ 탭을 선택합니다. Spark는 목표를 실행하는 ‘작업(무엇을 할지)’, 자동 실행 조건을 정하는 ‘일정(언제 할지)’, 반복 절차를 저장하는 ‘기능(어떻게 할지)’을 조합하는 개인용 AI 에이전트입니다. 가운데 입력창에서 새 작업을 요청하고, 왼쪽 ‘작업’에서는 진행 상황을, ‘일정’에서는 자동 실행을, ‘기능’에서는 재사용 지침을 순서대로 관리합니다. ‘연결된 앱’에는 Spark가 사용할 수 있는 Google 서비스와 허용된 앱이 표시됩니다. 공식 안내상 만 18세 이상의 개인 Google 계정, 지원되는 Google AI Pro 또는 Ultra 구독과 Gemini 앱 활동 유지가 필요하며 업무·학교 계정에서는 현재 지원되지 않습니다. 로그인·결제 정보나 민감한 내용을 작업 대화에 직접 입력하지 말고, 실제 변경이나 전송 전에는 대상과 승인 화면을 확인해 주세요.",
                                                                  "image":  "./guidebook-assets/gemini_spark_start.png",
                                                                  "badge":  "시작 화면"
                                                              },
                                                              {
                                                                  "title":  "작업 메인에서 새 작업을 요청하고 상태별로 찾습니다",
                                                                  "body":  "왼쪽 ‘작업’을 누르면 상단의 ‘작업을 설명하세요’ 입력창과 기존 작업 목록이 표시됩니다. 입력창에는 ‘공식 공개 자료를 사용해 최근 7일간 국내외 생성형 AI 정책 발표를 조사하고, 발표일·기관·핵심 내용·원문 링크를 표로 정리해 주세요. 출처가 확인되지 않은 내용은 제외해 주세요.’처럼 목표, 조사 범위, 결과 형식과 완료 기준을 함께 적습니다. + 버튼에서는 기기 파일·Drive 파일·Notebook을 추가할 수 있고, /를 입력하면 저장된 기능을 지정할 수 있습니다. 아래 필터는 최근, 예약됨, 입력 필요, 진행 중, 완료됨으로 작업을 나누어 보여 줍니다. ‘입력 필요’에는 로그인·승인·추가 설명 등 사용자의 조치가 필요한 작업이 모이며, 카드의 더보기에서는 작업을 고정하거나 이름을 바꾸고 삭제할 수 있습니다.",
                                                                  "image":  "./guidebook-assets/gemini_spark_02_tasks_main.png",
                                                                  "badge":  "작업 메인"
                                                              },
                                                              {
                                                                  "title":  "완료된 작업의 결과를 검토하고 후속 작업을 지시합니다",
                                                                  "body":  "작업 카드를 열면 왼쪽에는 같은 작업의 대화와 상태가, 오른쪽에는 조사표·문서·웹 작업 같은 결과가 표시됩니다. 하단 입력창에서 ‘공식 기관 자료만 남기고 국가별 시사점을 3줄로 추가해 주세요.’처럼 후속 지시를 이어갈 수 있습니다. 화면은 채팅과 비슷하지만 일반 채팅이 질문과 답변을 주고받는 데 중심을 둔다면, Spark 작업은 하나의 목표를 계획하고 여러 단계로 실행하면서 진행 상태, 사용하거나 수정한 파일, 기능·연결 앱, 일정과 승인 요청을 작업 단위로 관리한다는 차이가 있습니다. 상단 진행 상태나 작업 패널에서 완료·진행 중·예정 단계와 읽거나 만든 파일을 확인하고, 브라우저 조작이나 외부 변경이 필요한 경우 계획을 검토한 뒤 승인하거나 직접 제어합니다. 첨부 화면처럼 ‘완료’로 표시돼도 정책명·날짜·링크와 표의 내용은 연결된 공식 원문을 다시 열어 확인해 주세요.",
                                                                  "image":  "./guidebook-assets/gemini_spark_03_task_result.png",
                                                                  "badge":  "작업 결과"
                                                              },
                                                              {
                                                                  "title":  "기능 메인에서 만들기 방법과 추천 기능을 선택합니다",
                                                                  "body":  "왼쪽 ‘기능’을 누르면 반복 사용할 처리 절차를 관리하는 화면이 열립니다. 기능은 특정 질문의 답을 저장하는 것이 아니라, 여러 Spark 작업에서 다시 쓸 역할·판단 기준·처리 순서·출력 형식을 저장하는 맞춤 요청 사항입니다. ‘Gemini로 만들기’는 대화를 통해 필요한 절차를 정리할 때, ‘수동으로 만들기’는 이름·설명·지침을 직접 입력할 때 사용합니다. 업로드 아이콘에서는 루트에 SKILL.md가 있는 파일이나 ZIP 기능을 가져올 수 있습니다. 아래 추천 기능을 누르면 제공된 템플릿의 이름·설명·지침을 검토해 자신의 방식으로 수정할 수 있습니다. 활성 기능은 관련 작업에서 Spark가 자동으로 적용할 수 있고, 사용자가 입력창에 /를 입력해 직접 선택할 수도 있습니다.",
                                                                  "image":  "./guidebook-assets/gemini_spark_04_skills_main.png",
                                                                  "badge":  "기능 메인"
                                                              },
                                                              {
                                                                  "title":  "Gemini와 대화하며 반복할 기능을 만듭니다",
                                                                  "body":  "기능 메인에서 ‘Gemini로 만들기’를 누르면 Spark 작업 대화가 열리고, Gemini가 이 기능으로 처리할 업무와 필요한 세부 수준을 질문합니다. 처음에는 ‘읽지 않은 이메일을 요약해서 할 일에 추가해 줘.’처럼 목적을 말하되, 결과를 안정적으로 재사용하려면 ‘최근 24시간의 읽지 않은 Gmail에서 광고성 메일을 제외하고, 발신자·제목·핵심 요청·기한을 추출해 Google Tasks 후보 목록으로 보여 주세요. 실제 할 일을 만들기 전에는 확인을 요청하세요.’처럼 대상, 제외 조건, 출력 항목과 승인 조건까지 덧붙입니다. Gemini가 제안한 기능의 이름·설명·처리 단계를 확인하고 빠진 조건은 같은 대화에 추가합니다. 완성된 기능은 기능 목록에 저장되며, Gmail 검색과 Tasks 생성을 사용하려면 해당 연결 앱과 권한이 필요합니다.",
                                                                  "image":  "./guidebook-assets/gemini_spark_05_skill_create_with_gemini.png",
                                                                  "badge":  "Gemini로 만들기"
                                                              },
                                                              {
                                                                  "title":  "생성한 기능을 사용하고 수정·보관·중지합니다",
                                                                  "body":  "생성된 기능은 기능 메인의 ‘활성’ 목록에 표시됩니다. 카드의 더보기에서 ‘지금 사용’을 누르면 이 기능이 지정된 새 Spark 작업을 시작할 수 있고, 다른 작업의 입력창에서 /를 입력해 기능 이름을 선택할 수도 있습니다. 활성 상태에서는 요청과 관련성이 높을 때 Spark가 자동으로 사용할 수 있으므로, 작업 결과에서 어떤 기능이 사용됐는지 확인합니다. ‘Gemini로 수정’은 대화로 변경 내용을 설명하고, ‘직접 수정’은 설명·지침을 직접 편집합니다. ‘다운로드’는 기능을 ZIP으로 보관하며, ‘기능 바꾸기’는 새 SKILL.md 또는 ZIP을 업로드해 현재 기능을 교체합니다. 자동 적용을 막으려면 ‘비활성화’를 사용하고, ‘삭제’는 되돌릴 수 없으므로 필요한 경우 먼저 다운로드해 주세요.",
                                                                  "image":  "./guidebook-assets/gemini_spark_06_skill_created.png",
                                                                  "badge":  "기능 사용·관리"
                                                              },
                                                              {
                                                                  "title":  "일정 메인에서 자동 실행 방법을 선택합니다",
                                                                  "body":  "왼쪽 ‘일정’을 누르면 반복 실행, 이벤트 대응과 지속 모니터링을 관리하는 화면이 열립니다. ‘Gemini로 만들기’는 자연어로 작업 내용과 실행 조건을 함께 설명할 때 사용하며, 시간 조건뿐 아니라 특정 조건의 Gmail 수신이나 뉴스·금융·스포츠·지역 행사 같은 주제 변화 감시도 대화로 요청할 수 있습니다. ‘수동으로 만들기’는 이름, 실행 시점과 지침을 직접 입력하는 시간 기반 일정에 사용합니다. 작업 대화에서 생성된 일정도 이 화면에 자동으로 표시됩니다. 일반 Gemini 채팅의 예약된 작업과 Spark 일정은 별도 기능이며, Spark 일정은 작업·기능·연결 앱을 함께 실행하는 트리거입니다.",
                                                                  "image":  "./guidebook-assets/gemini_spark_07_schedules_main.png",
                                                                  "badge":  "일정 메인"
                                                              },
                                                              {
                                                                  "title":  "Gemini와 대화하며 실행 시점과 작업 범위를 정합니다",
                                                                  "body":  "일정 메인에서 ‘Gemini로 만들기’를 누른 뒤 무엇을, 어떤 자료에서, 언제 실행하고, 어떤 형식으로 받을지 한 문장에 작성합니다. 첨부 화면의 예시는 ‘매일 오전 9시 5분에, 전날 오전 9시부터 오늘 오전 9시까지 받은 Gmail을 확인해 발신자·제목·핵심 요청·기한과 필요한 후속 조치를 표로 정리해 주세요.’처럼 다듬어 입력할 수 있습니다. 날짜 범위와 실행 시각을 분리해 쓰면 중복이나 누락을 줄일 수 있습니다. Gmail과 같은 연결 앱이 필요하면 Gemini가 연결이나 권한 확인을 요청하며, 생성 과정에서 분석 절차와 일정이 만들어집니다. 기존 기능을 적용하려면 입력 중 /를 눌러 선택합니다. 민감하거나 외부 전송이 포함된 일정은 오프라인에서도 실행될 수 있으므로 만들지 않는 편이 안전합니다.",
                                                                  "image":  "./guidebook-assets/gemini_spark_08_schedule_create_with_gemini.png",
                                                                  "badge":  "Gemini로 일정 만들기"
                                                              },
                                                              {
                                                                  "title":  "생성한 일정을 시험하고 수정·중지합니다",
                                                                  "body":  "일정이 만들어지면 ‘진행 중’ 목록에 이름, 실행 시각과 현재 상태가 표시됩니다. 카드의 말풍선 아이콘은 일정이 연결된 작업 대화를 열어 생성 과정과 실행 결과를 확인할 때 사용합니다. 더보기의 ‘Gemini로 수정’은 관련 대화에서 변경 내용을 설명하고, ‘직접 수정’은 이름·실행 시점·지침을 직접 바꿉니다. 처음에는 ‘지금 실행’으로 즉시 시험해 Gmail 범위와 표 형식이 맞는지 확인한 뒤 실제 반복 실행을 맡깁니다. ‘일시중지’는 설정을 남긴 채 실행을 멈추고, ‘삭제’는 일정을 제거합니다. 실행 시각은 화면처럼 ‘오전 9:05경’으로 표시되는 근사값이며 트래픽과 사용량에 따라 지연될 수 있으므로 즉시 대응 업무에는 사용하지 않습니다. 관련 Spark 작업 대화를 삭제하면 그 대화에 속한 일정도 함께 삭제될 수 있습니다.",
