    ...
    "services":  [
                     {
                         ...
                         "tone":  "#10b981",
                         "role":  "글쓰기, 요약, 번역, 파일 분석까지 한 대화에서 처리하는 범용 업무 보조",
                         "basis":  "2026-08-07",
                         "overview":  "범용 업무 보조가 필요할 때 적합하다. 글쓰기, 요약, 번역, 자료 분석, 이미지 이해, 웹 조사, 파일 기반 질의응답을 한 대화 안에서 이어갈 수 있다.",
                         ...
                         "sections":  [
                                          {
                                              ...
                                              "location":  "채팅 입력창에 업무 요청을 자연어로 입력한다.",
                                              "when":  "문서 초안, 이메일, 번역, 요약, 회의 준비, 아이디어 정리가 필요할 때 쓴다.",
                                              "how":  "첫 요청은 \u0027무엇을, 어떤 형식으로, 누구에게 보여줄지\u0027를 같이 적는다."
                                          },
                                          {
                                              "title":  "웹 검색",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "최신 정보가 필요한 질문을 입력하고 출처가 필요한지 함께 요청한다.",
                                              "when":  "시장 동향, 경쟁사 조사, 정책 변화, 최신 제품 정보 확인에 쓴다.",
                                              "how":  "답변의 출처를 열어 원문 날짜와 맥락을 확인한다."
                                          },
                                          {
                                              "title":  "Deep Research",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "복잡한 조사 주제를 주고 보고서 형식, 비교 기준, 포함할 범위를 지정한다.",
                                              "when":  "여러 자료를 읽고 근거가 있는 조사 보고서가 필요할 때 쓴다.",
                                              "how":  "최종 보고서는 그대로 배포하지 말고 핵심 근거를 재확인한다."
                                          },
                                          {
                                              "title":  "파일 업로드",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "첨부 버튼으로 PDF, 문서, 표, 이미지를 올린 뒤 분석 요청을 한다.",
                                              "when":  "회의록, 계약서, 제안서, 엑셀 파일을 빠르게 파악할 때 쓴다.",
                                              "how":  "민감 자료는 회사 업로드 정책을 확인한 뒤 사용한다."
                                          },
                                          {
                                              "title":  "데이터 분석",
                                              "image":  "./guidebook-assets/chatgpt_data_analysis.png",
                                              "location":  "CSV나 스프레드시트를 올리고 원하는 분석 기준을 말한다.",
                                              "when":  "매출 추세, 이상치, 요약 통계, 차트, 표 정리가 필요할 때 쓴다.",
                                              "how":  "분석 결과 숫자는 원본 파일과 한 번 대조한다."
                                          },
                                          {
                                              "title":  "이미지 입력/생성",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "스크린샷이나 이미지를 올려 해석을 요청하거나, 만들 이미지의 목적과 스타일을 설명한다.",
                                              "when":  "화면 오류 해석, 디자인 피드백, 자료용 이미지 초안 제작에 쓴다.",
                                              "how":  "브랜드/저작권이 걸린 이미지는 사용 권한을 확인한다."
                                          },
                                          {
                                              "title":  "Canvas",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "긴 문서나 초안을 별도 편집 화면으로 열어 부분 수정한다.",
                                              "when":  "보고서, 제안서, 교육자료처럼 여러 번 다듬어야 하는 산출물에 적합하다.",
                                              "how":  "문단별로 \u0027이 부분만 줄여줘\u0027처럼 좁게 지시하면 좋다."
                                          },
                                          {
                                              "title":  "Projects",
                                              "image":  "./guidebook-assets/chatgpt_projects.png",
                                              "location":  "프로젝트를 만들고 관련 파일, 지침, 대화를 한곳에 모은다.",
                                              "when":  "반복되는 팀 업무, 특정 고객사/제품/프로젝트 자료를 계속 참조할 때 쓴다.",
                                              "how":  "프로젝트 지침에 문체, 보고서 형식, 금지 표현을 넣어 둔다."
                                          },
                                          {
                                              "title":  "GPTs",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "탐색 화면에서 목적에 맞는 GPT를 선택하거나 반복 업무용 GPT를 만든다.",
                                              "when":  "번역, 문서 검토, 교육자료 작성처럼 자주 반복되는 작업에 쓴다.",
                                              "how":  "외부 GPT를 쓸 때는 입력 자료 범위와 보안 정책을 확인한다."
                                          },
                                          {
                                              "title":  "Voice와 예약 작업",
                                              "image":  "./guidebook-assets/chatgpt_overview.png",
                                              "location":  "음성 대화로 아이디어를 정리하거나 특정 시점에 확인할 작업을 예약한다.",
                                              "when":  "이동 중 메모, 반복 리마인드, 정기 점검 목록 관리에 쓴다.",
                                              "how":  "업무상 중요한 알림은 캘린더/업무툴에도 별도 기록한다."
                                          }
                                      ],
                         "sources":  [
