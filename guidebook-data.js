                     ...
                     },
                     {
                         ...
                         "sections":  [
                                          ...
                                          },
                                          {
                                              "title":  "딥 리서치",
                                              "image":  "./guidebook-assets/genspark_workspace_main.png",
                                              "location":  "모든 에이전트에서 딥 리서치를 선택한 뒤 입력창에 조사할 주제와 결과물 형식을 적습니다.",
                                              "when":  "여러 출처를 넓게 찾고, 핵심 내용·표·전망·출처 목록까지 보고서처럼 정리해야 할 때 사용합니다.",
                                              "how":  "요청을 세부 조사 항목으로 나누어 관련 자료를 더 넓게 찾고, 결과를 표와 문단, 참고 자료 목록으로 정리합니다. 조사 범위, 기간, 언어, 출처 기준, 최종 형식을 함께 적으면 검토하기 쉽습니다.",
                                              "steps":  [
                                                            {
                                                                "title":  "딥 리서치를 클릭합니다",
                                                                "body":  "Genspark 메인 화면의 입력창 아래에서 모든 에이전트를 클릭한 뒤 하단으로 스크롤해 딥 리서치를 선택합니다. 여러 자료를 깊게 조사해 보고서 형태로 정리해야 할 때 사용합니다.",
                                                                "image":  "./guidebook-assets/genspark_all_agents_tools.png",
                                                                "badge":  "선택"
                                                            },
                                                            {
                                                                "title":  "조사할 내용을 입력합니다",
                                                                "body":  "입력창에 조사 주제와 원하는 결과물 형식을 적습니다. 예: “2026년 모든 AI 관련 자료를 수집해서 정리해줘.”처럼 작성할 수 있고, 더 좋은 결과를 위해 기간, 지역, 출처 범위, 표로 정리할 항목, 결론에 포함할 전망을 함께 적으면 좋습니다. 딥 리서치는 요청을 세부 항목으로 나누어 더 많은 자료를 찾는 방식에 가깝기 때문에 질문을 넓게 쓰되 검토 기준은 구체적으로 적습니다.",
                                                                "image":  "./guidebook-assets/genspark_deep_research_main.png",
                                                                "badge":  "요청 작성"
                                                            },
                                                            {
                                                                "title":  "보고서와 출처를 검토합니다",
